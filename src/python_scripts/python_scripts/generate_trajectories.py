...
class TrajectoryGenerator(Node):
    ...
    def generate_and_save_trajectories(self):
        ...
        waypoints = [
            ...
            [ -0.5,  0.6,  0.0,  0.0],   # 1: raise arm
            [ 0.5,  0.6,  0.0,  0.0],   # 2: rotate right  (+86°)
            [-0.5,  0.6,  0.0,  0.0],   # 3: rotate left   (−69°)
            [ 0.5,  0.6,  0.0,  0.0],   # 4: rotate right  again
            [-0.5,  0.6,  0.0,  0.0],   # 5: rotate left   again
            [ 0.5,  0.6,  0.0,  0.0],   # 6: end at right
        ...
        filename = os.path.join(self.save_path, "task_4.json")
